classdef NNTest < IntegratorTest
    ...
    methods (TestClassSetup)
        function addIntegrators(testCase)
            ...
            ks{3} = NN({singleLayer(convMCN([12 8],[3 3 2 5])),singleLayer(convMCN([12 8], [5 5 5 4])) });
            ...
            ks{6} = NN({singleLayer(convMCN([12 8],[3 3 2 5])), reshapeLayer([12 8 5], prod([12 8 5])),singleLayer(dense([10 5*12*8])) },'useGPU',0,'precision','single');
